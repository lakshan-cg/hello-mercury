...
export default function HomePage() {
  ...
  return (
    <main className="relative min-h-screen w-full bg-[#0f172a] overflow-hidden flex items-center justify-center font-sans text-[#f8fafc]">
      ...
      <div className="absolute top-[15%] right-[10%] sm:top-[20%] sm:right-[20%] w-32 h-32 sm:w-56 sm:h-56 rounded-full bg-[radial-gradient(circle_at_30%_30%,_#cbd5e1_0%,_#334155_50%,_#0f172a_100%)] shadow-[0_0_50px_rgba(51,65,85,0.5)] opacity-90 z-0 pointer-events-none" />
